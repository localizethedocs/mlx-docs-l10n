...
if (VERSION MATCHES "^([0-9]+)\\.([0-9]+)$" AND
    VERSION VERSION_LESS_EQUAL    "0.11"    AND
    VERSION VERSION_GREATER_EQUAL "0.0")
else()
    message(STATUS "Running 'doxygen' command to generate .xml files...")
