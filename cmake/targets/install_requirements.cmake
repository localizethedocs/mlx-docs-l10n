...
execute_process(
    COMMAND ${Conda_EXECUTABLE} install
            conda-forge::zsh=${VERSION_OF_ZSH}
            conda-forge::gcc=${VERSION_OF_GCC}
            conda-forge::gxx=${VERSION_OF_GCC}
            conda-forge::binutils=${VERSION_OF_BINUTILS}
            conda-forge::doxygen=${VERSION_OF_DOXYGEN}
            conda-forge::openblas=${VERSION_OF_OPENBLAS}
            conda-forge::openmpi=${VERSION_OF_OPENMPI}
...
message(STATUS "Running 'pip install' command to install the 'mlx' package from sources...")
if (CMAKE_HOST_LINUX)
    set(ENV_PATH                "${PROJ_CONDA_DIR}/bin:$ENV{PATH}")
    set(ENV_LD_LIBRARY_PATH     "${PROJ_CONDA_DIR}/lib:$ENV{LD_LIBRARY_PATH}")
    set(ENV_CMAKE_PREFIX_PATH   "${PROJ_CONDA_DIR}")  # Required for finding include dirs of BLAS and Lapack
    set(ENV_VARS_OF_SYSTEM      PATH=${ENV_PATH}
                                LD_LIBRARY_PATH=${ENV_LD_LIBRARY_PATH}
